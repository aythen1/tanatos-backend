...
let OrderController = class OrderController {
    ...
    async create(createOrderDto, store_id, esquela_id, client_id) {
        return this.orderService.create(createOrderDto, store_id, esquela_id, client_id);
    }
    async findAll() {
...
__decorate([
    (0, common_1.Post)(':store_id/:esquela_id/:client_id'),
    __param(0, (0, common_1.Body)()),
    __param(1, (0, common_1.Param)('store_id')),
    __param(2, (0, common_1.Param)('esquela_id')),
    __param(3, (0, common_1.Param)('client_id')),
...
__decorate([
    (0, common_1.Get)(':storeId/orders/:status'),
    __param(0, (0, common_1.Param)('storeId')),
    __param(1, (0, common_1.Param)('status')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, String]),
    __metadata("design:returntype", Promise)
], OrderController.prototype, "findOrdersByStoreId", null);
